  ...
  <div class="flex flex-col items-center gap-y-3">
    ...
    <div class="flex items-center gap-x-2">
      ...
      <div class="w-[135px] flex flex-col">
        ...
        <input class="w-full h-[37px] rounded-lg pl-3 lexend text-xs" type='text'>
      </div>
    ...
    <!-- Year & Section -->
    <div class="flex items-center gap-x-2">
      <SelectField bind:value={selectedGrade} width='135px' data={grade}>
        <div class="lexend text-[12px]">
          Year
        </div>
      </SelectField>
      
      <SelectField bind:value={selectedSection} width='135px' data={selectedGrade === '11' ? sectionsOf11 : sectionsOf12}>
        <div class="lexend text-[12px]">
          Section
        </div>
      </SelectField>
